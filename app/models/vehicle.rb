class Vehicle < ApplicationRecord
  ...
  validates :folder_code, presence: true
  validates_uniqueness_of :folder_code, scope: :location_id

  # Auto-populate code from folder_code before saving
  before_save :set_code_from_folder_code

  def set_code_from_folder_code
    self.code ||= self.folder_code
  end
