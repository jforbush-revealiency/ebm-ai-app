...
(function () {
  ...
  angular.module('manufacturers').controller('manufacturersController',
      [
        '$scope',
        'messageBoxService',
        'manufacturerApiService',
        function($scope, messageBoxService, manufacturerApiService) {
          var viewModel = {
            allData: [],
            id: null,
            code: null,
          ...
          function initScope() {
            ...
            // Get Data
            manufacturerApiService.getAll().$promise.then(onDataLoaded);
          }
          ...
          function save() {
            ...
            manufacturerApiService.save(data).then(function(data) {
              if (viewModel.selectedData) {
          ...
          function remove() {
            if (viewModel.selectedData) {
              manufacturerApiService.remove(viewModel.selectedData).then(function(data) {
